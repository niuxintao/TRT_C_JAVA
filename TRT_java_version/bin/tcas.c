...
/* $Log: tcas.c,v $
/* Revision 1.1.1.1  1998/07/22 21:55:19  jlaw
/* Aristotle sample analysis programs
/*
...
#define UNRESOLVED1 3
#define UNRESOLVED2 4
...
{
    initialize();
    scanf("%d%d%d", &Cur_Vertical_Sep, &High_Confidence,
	   &Two_of_Three_Reports_Valid);
    scanf("%d%d%d", &Own_Tracked_Alt, &Own_Tracked_Alt_Rate,
	   &Other_Tracked_Alt);
    scanf("%d%d%d", &Alt_Layer_Value, &Up_Separation,
	   &Down_Separation);
    scanf("%d%d%d", &Other_RAC, &Other_Capability, &Climb_Inhibit);
    printf("%d\n", alt_sep_test());
}
*/

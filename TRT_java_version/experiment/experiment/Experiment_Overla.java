...
public class Experiment_Overla {
	...
	public void test(int length, int value) {
		...
		System.out.println( "TRT "+ "2-way-Overlap:");
		testNO(2, experimentData, casedata);
		System.out.println( "TRT "+ "3-way-Overlap:");
		testNO(3, experimentData, casedata);
		System.out.println( "TRT "+ "4-way-Overlap:");
	...
	public void testNO(int degree,
		...
		System.out.println("TRT " + degree + "-way-Overlap:");
		int avg1 = 0;
		for (Integer i : all1) {
			avg1 += i;
		}
		...
		System.out.println("TRT_NA " + degree + "-way-Overlap:");
		int avg2 = 0;
		for (Integer i : all2) {
			avg2 += i;
		}
		...
		System.out.println("FIC " + degree + "-way-Overlap:");
		int avg3 = 0;
		for (Integer i : all3) {
			avg3 += i;
		}
	...
	public static void main(String[] args) {
		Experiment_Overla ex = new Experiment_Overla();
		ex.setOutPut("ExperimentOverlap" + "8,10_avg");
		ex.test(8, 10);
		Experiment_Overla ex2 = new Experiment_Overla();
		ex2.setOutPut("ExperimentOverlap" + "9,10_avg");
		ex2.test(9, 10);
		Experiment_Overla ex3 = new Experiment_Overla();
		ex3.setOutPut("ExperimentOverlap" + "10,10_avg");
		ex3.test(10, 10);
		Experiment_Overla ex4 = new Experiment_Overla();
		ex4.setOutPut("ExperimentOverlap" + "11,10_avg");
		ex4.test(11, 10);
		Experiment_Overla ex5 = new Experiment_Overla();
		ex5.setOutPut("ExperimentOverlap" + "12,10_avg");
		ex5.test(12, 10);
	}
}
